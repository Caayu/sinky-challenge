...
export const taskResponseSchema = z.object({
  ...
  category: z.nativeEnum(TaskCategory).optional().describe('The category of the task'),
  priority: z.nativeEnum(TaskPriority).optional().describe('The priority of the task'),
